...
public class PantallaBajaReptil extends JPanel{
	...
	public PantallaBajaReptil(Ventana v) {
		...
		JButton botonDarBaja = new JButton("DAR DE BAJA REPTIL");
		...
		JLabel txtReptil = new JLabel("REPTIL");
		txtReptil.setForeground(Color.WHITE);
		txtReptil.setFont(new Font("Arial Black", Font.BOLD, 20));
		txtReptil.setBounds(559, 245, 127, 42);
		add(txtReptil);
		...
		botonDarBaja.setBounds(290, 496, 202, 60);
		add(botonDarBaja);

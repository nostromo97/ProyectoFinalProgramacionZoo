...
public class Anfibio extends Animal {
	...
	/**
	 * Variable interna de la clase Anfibio de tipo boolean que indica 0 cuando es
	 * ambiente de tipo acuático y 1 cuando es de tipo seco.
	 */
	 ...
	 * @param tipoOrden       De tipo TipoOrden, proviene del Enum TipoOrden que
	 *                        contiene los tipos de ordenes del animal.
	 * @param tipoAmbiente    Variable de tipo boolean que contiene los 2 tipos de
	 *                        ambiente, acuático o seco, indicado con true y false
	 *                        respectivamente.
	 ...
	 * @throws TipoOrdenVacioException    Excepción que se lanza cuando no se
	 *                                    selecciona ningún tipo de orden.
	 * @throws TipoAmbienteVacioException Excepción que se lanza cuando no se
	 *                                    selecciona ningún tipo de ambiente.
	 */
	public Anfibio(short id, String nombre, LocalDate fechaNacimiento, TipoRaza raza, String cuidados,
			...
			TipoOrden tipoOrden, boolean tipoAmbiente)
			throws NombreVacioException, NombreInvalidoException, IdInvalidoException, IdVacioException,
			FechaFormatoException, MotivoVacioException, TipoOrdenVacioException, TipoAmbienteVacioException {
	...
	/**
	 * Constructor de la clase Anfibio que extiende de Animal, utilizado para dar de
	 * alta a un anfibio. Hace conexión con la base de datos e inserta un anfibio.
	 * 
	 * @param nombre          Cadena de caracteres que contiene el nombre del
	 *                        animal.
	 * @param fechaNacimiento Variable de tipo LocalDate que contiene la fecha de
	 ...
	 *                                    del animal.
	 */
	public Anfibio(String nombre, LocalDate fechaNacimiento, MotivoAlta motivoAlta, LocalDate fechaAlta,
			TipoOrden tipoOrden, boolean tipoAmbiente, String cuidados) throws NombreVacioException,
			NombreInvalidoException, FechaFormatoException, SQLException, MotivoVacioException, CampoVacioException,
			TipoOrdenVacioException, TipoAmbienteVacioException, DescripcionVaciaException {
		super(nombre, fechaNacimiento, motivoAlta, fechaAlta, cuidados);

		Statement query = UtilsDB.conectarBD();

		if (query.executeUpdate(
				"insert into altaAnfibio values(null,'" + nombre + "','" + fechaNacimiento + "','" + motivoAlta + "','"
						+ fechaAlta + "','" + tipoOrden + "'," + tipoAmbiente + ",'" + cuidados + "')") > 0) {
			this.setTipoOrden(tipoOrden);
			this.setTipoAmbiente(tipoAmbiente);
		} else {
	 ...
	 *                        nacimiento del animal.
	 * @param motivoBaja      Proviene del Enum MotivoBaja que contiene los motivos
	 *                        por el que se da de baja el animal.
	 * @param fechaBaja       De tipo LocalDate, contiene la fecha de baja del
	 *                        animal en el centro.
	 * @param tipoOrden       De tipo TipoOrden, proviene del Enum TipoOrden que
	 *                        contiene los tipos de ordenes del animal.
	 ...
	 *                                 selecciona ningún motivo.
	 */
	public Anfibio(short id, String nombre, LocalDate fechaNacimiento, MotivoBaja motivoBaja, LocalDate fechaBaja,
			TipoOrden tipoOrden, boolean tipoAmbiente, String cuidados) throws NombreVacioException,
			NombreInvalidoException, FechaFormatoException, SQLException, MotivoVacioException {
		super(id, nombre, fechaNacimiento, motivoBaja, fechaBaja, cuidados);
		Scanner sc = new Scanner(System.in);
		Statement query = UtilsDB.conectarBD();

		if (query.executeUpdate(
				"insert into bajaAnfibio values(null,'" + nombre + "','" + fechaNacimiento + "','" + motivoBaja + "','"
						+ fechaBaja + "','" + tipoOrden + "'," + tipoAmbiente + ",'" + cuidados + "')") > 0) {
	...
	/**
	 * Constructor de la clase Anfibio que extiende de Animal.
	 * 
	 * @param id           Variable numérica de tipo short que contiene el id del
	 *                     animal.
	...
	public String toString() {
		return super.toString() + "Tipo de Orden: " + tipoOrden + " Tipo de Ambiente: "
				+ (tipoAmbiente == true ? "Acuático" : "Seco");
	}

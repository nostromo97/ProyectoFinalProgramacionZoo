...
public class Reptil extends Animal{
	/**
	 * Variable de tipo boolean que indica el tipo de piel del reptil, escamas o caparazaón, siendo los valores true o false.
	 */
 ...
 * @param tipoPiel Variable de tipo boolean que indica el tipo de piel del reptil, escamas o caparazaón, siendo los valores true o false.
 ...
 */
	...
	/**
	 * 	Constructor de la clase Reptil que extiende de Animal, utilizado para dar de alta a un Reptil.
	 * 
	 * @param nombre Cadena de caracteres que contiene el nombre del animal.                         
	 * @param fechaNacimiento Variable de tipo LocalDate que contiene la fecha de nacimiento del animal.
	 * @param motivoAlta Proviene del Enum MotivoAlta que contiene los motivos de alta del animal.
	...
	/**
	 * 	Constructor de la clase Reptil que extiende de Animal, utilizado para dar de baja a un Reptil.
	 * 
	 * @param Variable numérica de tipo short que contiene el id del animal.    
	 * @param nombre Cadena de caracteres que contiene el nombre del animal.                         
	 * @param fechaNacimiento Variable de tipo LocalDate que contiene la fecha de nacimiento del animal.
	 * @param motivoBaja Proviene del Enum MotivoBaja que contiene los motivos de baja del animal.
	 * @param fechaBaja De tipo LocalDate, contiene la fecha de baja del animal en el centro.
